...
@Component({
  selector: 'app-especialidad-rm',
  templateUrl: './especialidad-rm.component.html',
  styleUrls: ['./especialidad-rm.component.css']
})
export class EspecialidadRmComponent implements OnInit {
