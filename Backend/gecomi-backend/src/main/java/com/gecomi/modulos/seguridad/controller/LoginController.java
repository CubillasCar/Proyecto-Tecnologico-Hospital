package com.gecomi.modulos.seguridad.controller;
...
import com.gecomi.modulos.seguridad.service.ILoginService;
import com.gecomi.modulos.seguridad.service.IResetTokenService;
import com.gecomi.modulos.util.misc.EmailUtil;
import com.gecomi.modulos.util.misc.Mail;
...
public class LoginController {
	...
	public ResponseEntity<Integer> enviarCorreo(@RequestBody String correo) throws Exception {
		...
		if(us != null && us.getIdUsuario() > 0) {
			...
			mail.setSubject("RESTABLECER CONTRASEÑA GECOMI");
